  ...
  <div class="container">
    <header class="blog-header py-3">
      <div class="row flex-nowrap justify-content-between align-items-center">
        ...
        <h4>
          <u><i><a class="blog-header-logo text-dark" href="#">Blog-post</a></i></u>
          </h3>
        </div>
    ...
    <div class="nav-scroller py-1 mb-2">
      <nav class="nav d-flex justify-content-between">
        <?php foreach ($categories as $value) : ?>
          <a class="p-2 text-muted" href="http://localhost/php/CodeIgniter/CodeIgniter-3.1.11/index.php/FakerController/ShowCategoryList/<?=$value['id']?>"><?=$value['name']?></a>
        <?php endforeach ?>
      </nav>
    </div>
    ...
    <div class="jumbotron p-4 p-md-5 text-white rounded bg-dark">
      <div class="col-md-6 px-0">
        <h1 class="display-4 font-italic">fff</h1>
        <p class="lead my-3">fdf</p>
        <p class="lead mb-0"><a href="" class="text-white font-weight-bold">1</a></p>
      </div>
    </div>
      ...
      <div class="col-md-6">
        <div class="row no-gutters border rounded overflow-hidden flex-md-row mb-4 shadow-sm h-md-250 position-relative">
          <div class="col p-4 d-flex flex-column position-static">
            ...
            <a href="" class="stretched-link">1</a>
          </div>
    ...
    <div class="row">
      <div class="col-md-8 blog-main">
        ...
        <div class="blog-post">
          ...
          <p>Cum sociis natoque penatibus et magnis <a href=""></a>, nascetur ridiculus mus. Aenean eu leo quam. Pellentesque ornare sem lacinia quam
        ...
        <div class="blog-post">
          ...
          <p>Cum sociis natoque penatibus et magnis <a href="">1</a>, nascetur ridiculus mus. Aenean eu leo quam. Pellentesque ornare sem lacinia quam
            venenatis vestibulum. Sed posuere consectetur est at lobortis. Cras mattis consectetur purus sit amet
            fermentum.</p>
          <blockquote>
            <p>Curabitur blandit tempus porttitor. <strong>Nullam quis risus eget urna mollis</strong> ornare vel eu
        ...
        <div class="blog-post">
          ...
          <p class="blog-post-meta">December 14, 2013 by <a href="">1</a></p>
