  ...
  <div class="container">
    <header class="blog-header py-3">
      <div class="row flex-nowrap justify-content-between align-items-center">
        <div class="col-4 pt-1">
          <?php $i = 0; ?>
          <a class="text-muted" href="<?= $url . $links[$i] ?>"><?= $links[$i++] ?></a>
        </div>
        <div class="col-4 text-center">
          <a class="blog-header-logo text-dark" href="<?= $url . $links[$i] ?>"><?= $links[$i++] ?></a>
        </div>
        <div class="col-4 d-flex justify-content-end align-items-center">
          <a class="text-muted" href="<?= $url . $links[$i] ?>" aria-label="Search">
          ...
          <a class="btn btn-sm btn-outline-secondary" href="<?= $url . $links[$i] ?>"><?= $links[$i++] ?></a>
        </div>
      </div>
    </header>
    ...
    <div class="nav-scroller py-1 mb-2">
      <nav class="nav d-flex justify-content-between">
        <?php for ($j = 0; 12 > $j; $j++) : ?>
          <a class="p-2 text-muted" href="<?= $url . $links[$i] ?>"><?= $links[$i++] ?></a>
        <?php endfor ?>
      </nav>
    </div>
    ...
    <div class="jumbotron p-4 p-md-5 text-white rounded bg-dark">
      <div class="col-md-6 px-0">
        ...
        <p class="lead mb-0"><a href="<?= $url . $links[$i] ?>" class="text-white font-weight-bold"><?= $links[$i++] ?></a></p>
      </div>
    </div>
      ...
      <div class="col-md-6">
        <div class="row no-gutters border rounded overflow-hidden flex-md-row mb-4 shadow-sm h-md-250 position-relative">
          <div class="col p-4 d-flex flex-column position-static">
            ...
            <a href="<?= $url . $links[$i] ?>" class="stretched-link"><?= $links[$i++] ?></a>
          </div>
    ...
    <div class="row">
      <div class="col-md-8 blog-main">
        ...
        <div class="blog-post">
          ...
          <p class="blog-post-meta">January 1, 2014 by <a href="<?= $url . $links[$i] ?>"><?= $links[$i++] ?></a></p>
          ...
          <p>Cum sociis natoque penatibus et magnis <a href="<?= $url . $links[$i] ?>"><?= $links[$i++] ?></a>, nascetur ridiculus mus. Aenean eu leo quam. Pellentesque ornare sem lacinia quam
            venenatis vestibulum. Sed posuere consectetur est at lobortis. Cras mattis consectetur purus sit amet
            fermentum.</p>
          <blockquote>
        ...
        <div class="blog-post">
          ...
          <p class="blog-post-meta">December 14, 2013 by <a href="<?= $url . $links[$i] ?>"><?= $links[$i++] ?></a></p>
        ...
        <nav class="blog-pagination">
          <a class="btn btn-outline-primary" href="<?= $url . $links[$i] ?>"><?= $links[$i++] ?></a>
          <a class="btn btn-outline-secondary disabled" href="<?= $url . $links[$i] ?>" tabindex="-1" aria-disabled="true"><?= $links[$i++] ?></a>
        </nav>
      ...
      <aside class="col-md-4 blog-sidebar">
        ...
        <div class="p-4">
          ...
          <ol class="list-unstyled mb-0">
            <?php for($j = 0; 12 > $j; $j++):?>
            <li><a href="<?= $url . $links[$i] ?>"><?= $links[$i++] ?></a></li>
            <? endfor?>
